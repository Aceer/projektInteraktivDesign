	...
	<div id="wrapper-head">
		<div class="head-box">
			...
			<ul class="nav nav-tabs" id="register-meny">
				...
				<li role="presentation"  class="active"><a href="#">Privatperson</a></li>
			</ul>
			</div>
		</div>
	</div>
	...
	<div class="panel">
		<div class="panel-body">
			<div class="row">
				<div class="col-lg-6 col-md-6">
					<div class="form-group">
						...
						<input type="text" class="form-control" aria-label="..."/ placeholder="Skriv hela namnet ex: Kalle karlsson">
					</div>
				</div>
				<div class="col-lg-6 col-md-6">
					<div class="form-group">
						<label class="control-label">Tel mobil</label>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6">
					<div class="form-group">
						<label class="control-label">Tel fast</label>
						<input type="text" class="form-control" aria-label="..."/ placeholder="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6">
